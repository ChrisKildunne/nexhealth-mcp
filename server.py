...
def create_appointment_type(
    ...
    written to the connected PMS/EHR. They are used to define what kinds of
    appointments providers offer and to control when patients can book them.
